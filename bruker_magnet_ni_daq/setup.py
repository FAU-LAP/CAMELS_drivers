...
setup(
    ...
    install_requires=['nomad_camels_support_ni_daq_signal @ git+https://github.com/FAU-LAP/CAMELS.git@new_device_management#subdirectory=instruments/Support/ni_daq_signal']
)