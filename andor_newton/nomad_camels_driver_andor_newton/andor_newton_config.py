...
class Ui_andor_newton_config(object):
    def setupUi(self, andor_newton_config):
        ...
        andor_newton_config.resize(355, 320)
        ...
        self.tracks_frame.setFrameShape(QFrame.Shape.StyledPanel)
        self.tracks_frame.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.exposure_time.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.NoButtons)
        self.exposure_time.setDecimals(5)
        self.exposure_time.setMaximum(99999.000000000000000)
