...
class Keysight_E5270B(VISA_Device):
    ...
    enable_ch_1 = Cpt(VISA_Signal, name='enable_ch_1',)
    disable_ch_1 = Cpt(VISA_Signal, name='disable_ch_1',)
    # Config settings of the device
    measMode1 = Cpt(VISA_Signal, name='measMode1', kind='config',)
    ...
    setADC1 = Cpt(VISA_Signal, name='setADC1', kind='config',)
    # sets filter mode: 0 for disconnect, 1 for connect of the filter
    outputFilter1 = Cpt(VISA_Signal, name='outputFilter1', kind='config', )
    # --------------------Channel 2----------------------------------------
    ...
    enable_ch_2 = Cpt(VISA_Signal, name='enable_ch_2', )
    disable_ch_2 = Cpt(VISA_Signal, name='disable_ch_2', )
    # Config settings of the device
    measMode2 = Cpt(VISA_Signal, name='measMode2', kind='config', )
    # used in setting current DI and setting voltage DV, only a variable
    ...
    # sets ADC to high resolution(=1) or high speed(=0), default is high speed
    setADC2 = Cpt(VISA_Signal, name='setADC2', kind='config', )
    # sets filter mode: 0 for disconnect, 1 for connect of the filter
    outputFilter2 = Cpt(VISA_Signal, name='outputFilter2', kind='config', )
    # --------------------Channel 3----------------------------------------
    ...
    enable_ch_3 = Cpt(VISA_Signal, name='enable_ch_3', )
    disable_ch_3 = Cpt(VISA_Signal, name='disable_ch_3', )
    # Config settings of the device
    measMode3 = Cpt(VISA_Signal, name='measMode3', kind='config', )
    # used in setting current DI and setting voltage DV, only a variable
    ...
    # sets ADC to high resolution(=1) or high speed(=0), default is high speed
    setADC3 = Cpt(VISA_Signal, name='setADC3', kind='config', )
    # sets filter mode: 0 for disconnect, 1 for connect of the filter
    outputFilter3 = Cpt(VISA_Signal, name='outputFilter3', kind='config', )
    # --------------------Channel 4----------------------------------------
    ...
    enable_ch_4 = Cpt(VISA_Signal, name='enable_ch_4', )
    disable_ch_4 = Cpt(VISA_Signal, name='disable_ch_4', )
    # Config settings of the device
    measMode4 = Cpt(VISA_Signal, name='measMode4', kind='config', )
    # used in setting current DI and setting voltage DV, only a variable
    ...
    # sets ADC to high resolution(=1) or high speed(=0), default is high speed
    setADC4 = Cpt(VISA_Signal, name='setADC4', kind='config', )
    # sets filter mode: 0 for disconnect, 1 for connect of the filter
    outputFilter4 = Cpt(VISA_Signal, name='outputFilter4', kind='config', )
    # --------------------Channel 5----------------------------------------
    ...
    enable_ch_5 = Cpt(VISA_Signal, name='enable_ch_5', )
    disable_ch_5 = Cpt(VISA_Signal, name='disable_ch_5', )
    # Config settings of the device
    measMode5 = Cpt(VISA_Signal, name='measMode5', kind='config', )
    # used in setting current DI and setting voltage DV, only a variable
    ...
    # sets ADC to high resolution(=1) or high speed(=0), default is high speed
    setADC5 = Cpt(VISA_Signal, name='setADC5', kind='config', )
    # sets filter mode: 0 for disconnect, 1 for connect of the filter
    outputFilter5 = Cpt(VISA_Signal, name='outputFilter5', kind='config', )
    # --------------------Channel 6----------------------------------------
    ...
    enable_ch_6 = Cpt(VISA_Signal, name='enable_ch_6', )
    disable_ch_6 = Cpt(VISA_Signal, name='disable_ch_6', )
    # Config settings of the device
    measMode6 = Cpt(VISA_Signal, name='measMode6', kind='config', )
    # used in setting current DI and setting voltage DV, only a variable
    ...
    # sets ADC to high resolution(=1) or high speed(=0), default is high speed
    setADC6 = Cpt(VISA_Signal, name='setADC6', kind='config', )
    # sets filter mode: 0 for disconnect, 1 for connect of the filter
    outputFilter6 = Cpt(VISA_Signal, name='outputFilter6', kind='config', )
    # --------------------Channel 7----------------------------------------
    ...
    enable_ch_7 = Cpt(VISA_Signal, name='enable_ch_7', )
    disable_ch_7 = Cpt(VISA_Signal, name='disable_ch_7', )
    # Config settings of the device
    measMode7 = Cpt(VISA_Signal, name='measMode7', kind='config', )
    # used in setting current DI and setting voltage DV, only a variable
    ...
    # sets ADC to high resolution(=1) or high speed(=0), default is high speed
    setADC7 = Cpt(VISA_Signal, name='setADC7', kind='config', )
    # sets filter mode: 0 for disconnect, 1 for connect of the filter
    outputFilter7 = Cpt(VISA_Signal, name='outputFilter7', kind='config', )
    # --------------------Channel 8----------------------------------------
    ...
    enable_ch_8 = Cpt(VISA_Signal, name='enable_ch_8', )
    disable_ch_8 = Cpt(VISA_Signal, name='disable_ch_8', )
    # Config settings of the device
    measMode8 = Cpt(VISA_Signal, name='measMode8', kind='config', )
    # used in setting current DI and setting voltage DV, only a variable
    ...
    # sets ADC to high resolution(=1) or high speed(=0), default is high speed
    setADC8 = Cpt(VISA_Signal, name='setADC8', kind='config', )
    # sets filter mode: 0 for disconnect, 1 for connect of the filter
    outputFilter8 = Cpt(VISA_Signal, name='outputFilter8', kind='config', )
