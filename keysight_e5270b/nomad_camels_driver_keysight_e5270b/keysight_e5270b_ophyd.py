...
from nomad_camels.bluesky_handling.visa_signal import VISA_Signal_Read, VISA_Signal_Write, VISA_Device
...
class Keysight_E5270B(VISA_Device):
    ...
    def __init__(self, prefix='', *, name, kind=None, read_attrs=None,
        ...
        self.resADCmode.put_conv_function = lambda x: self.set_resADC_mode(1, x)
        #Mode and NPLC of the High Speed AD converters for the entire SMU
        self.speedADCmode.put_conv_function = lambda x: self.set_speedADC_mode(0, x)
