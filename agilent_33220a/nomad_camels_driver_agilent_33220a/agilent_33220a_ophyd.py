...
def generate_waveform(tone_params, noise_level=0.0, offset=0.0, sampling_rate=1000, num_samples=1000, seed=-1):
    """
...
if __name__ == '__main__':
    ...
    wv = generate_waveform([{'frequency': 100, 'amplitude': 1, 'phase': 0},
                            {'frequency': 50, 'amplitude': 1, 'phase': 0}], sampling_rate=200000, num_samples=20000)
