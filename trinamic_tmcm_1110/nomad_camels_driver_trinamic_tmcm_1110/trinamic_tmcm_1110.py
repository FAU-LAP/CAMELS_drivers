from nomad_camels_driver_trinamic_tmcm_1110.trinamic_tmcm_1110_ophyd import (
    TMCM_1110,
...
class subclass_config(device_class.Simple_Config):
    ...
    def __init__(
        ...
        comboboxes = {
            "ref_search_mode": list(reference_search_modes.keys()),
